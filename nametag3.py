...
if __name__ == "__main__":
    ...
    parser.add_argument("--learning_rate_decay", default="cosine", choices=["none", "cosine"], help="Learning rate decay strategy.")
    parser.add_argument("--learning_rate_frozen", default="1e-3", type=float, help="Learning rate for frozen pretraining.")
    parser.add_argument("--learning_rate_frozen_decay", default="cosine", choices=["none", "cosine"], help="Learning rate decay strategy for frozen pretraining.")
