...
- Czech CNEC 2.0 Model `nametag3-czech-cnec2.0-2422803`: [training script](https://github.com/ufal/nametag3/blob/main/train_nametag3-czech-cnec2.0-240830_on_slurm_gpu.sh), [model documentation](https://ufal.mff.cuni.cz/nametag/3/models#czech-cnec2), [model download](http://hdl.handle.net/11234/1-5677)
...
- Multilingual CoNLL Model `nametag3-multilingual-conll-240803`: [training script](https://github.com/ufal/nametag3/blob/main/train_nametag3-multilingual-conll-240830_on_slurm_gpu.sh), [model documentation](https://ufal.mff.cuni.cz/nametag/3/models#multilingual-conll), [model download](http://hdl.handle.net/11234/1-5678).
