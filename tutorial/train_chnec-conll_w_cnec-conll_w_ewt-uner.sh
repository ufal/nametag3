...
$PYTHON nametag3.py \
  ...
  --corpus="czech-cnec2.0-conll,czech-chnec-conll,english-UNER_English-EWT-uner" \
  --decoding="classification" \
  --dev_data="$DATA/czech-cnec2.0-conll/dev.conll,$DATA/czech-chnec-conll/dev.conll,$DATA/english-UNER_English-EWT-uner/dev.conll" \
  --epochs=20 \
  --evaluate_test_data \
  ...
  --test_data="$DATA/czech-cnec2.0-conll/test.conll,$DATA/czech-chnec-conll/test.conll,$DATA/english-UNER_English-EWT-uner/test.conll" \
  --train_data="$DATA/czech-cnec2.0-conll/train.conll,$DATA/czech-chnec-conll/train.conll,$DATA/english-UNER_English-EWT-uner/train.conll" \
