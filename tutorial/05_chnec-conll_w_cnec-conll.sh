...
$PYTHON nametag3.py \
  ...
  --dev_data="$DATA/czech-cnec2.0-conll/dev.conll,$DATA/czech-chnec-conll/dev.conll" \
  --epochs=20 \
  --evaluate_test_data \
  ...
  --test_data="$DATA/czech-cnec2.0-conll/test.conll,$DATA/czech-chnec-conll/test.conll" \
  --train_data="$DATA/czech-cnec2.0-conll/train.conll,$DATA/czech-chnec-conll/train.conll" \
